    ...
    (t.prototype = t.fn = {
      ...
      init: function(i, o) {
        ...
        var c = [
          ...
          '<div class="' + r + 'container-mask" style="display:block;"></div>',
        ...
        return (
          ...
          ('function' == typeof define && define.amd) || !n.autoLoadModules
            ? ('undefined' != typeof CodeMirror && (t.$CodeMirror = CodeMirror),
      ...
      setTheme: function(e) {
        ...
        return (
          t.removeClass(o + i).addClass(o + e), (this.settings.theme = e), this
        );
      },
      ...
      on: function(t, i) {
        var o = this.settings;
        return (
          'undefined' != typeof o['on' + t] && (o['on' + t] = e.proxy(i, this)),
          this
        );
      },
      off: function(e) {
          ...
          ? ((this.state.preview = !0),
            ...
            r
              ...
              .css({
                ...
                width: o.width(),
                height:
                  a.autoHeight && !this.state.fullscreen ? 'auto' : o.height(),
              }),
